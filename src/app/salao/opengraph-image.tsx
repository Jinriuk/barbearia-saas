...
export const alt = "NexoBeleza — o sistema completo para o seu salão de beleza";
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <div style={{ fontSize: 30, color: "#33202b99", maxWidth: 900 }}>
          Agenda online, financeiro automático e uma página de agendamento linda
          com a sua marca. 7 dias grátis.
        </div>
      </div>
      <div
        style={{
