  ...
  return (
    <article>
      ...
      <p>
        ...
        clientes finais que agendam horários nas páginas públicas. Ao criar uma
        conta ou agendar um horário, você concorda com eles.
      </p>

      <h2>1. O serviço</h2>
      <p>
        A Plataforma oferece agenda online, página pública de agendamento,
        gestão de clientes, equipe, estoque e financeiro para estabelecimentos.
        A Plataforma é uma ferramenta de gestão: os serviços de beleza e
        barbearia são prestados exclusivamente pelo estabelecimento, único
        responsável por preços, horários, execução e atendimento.
      </p>

      <h2>2. Conta e responsabilidade</h2>
      <ul>
        <li>
          Você deve fornecer informações verdadeiras e manter a senha em sigilo;
          atividades na sua conta são de sua responsabilidade.
        </li>
        <li>
      ...
      <ul>
        <li>
          Novas contas têm período de teste gratuito de 7 dias, sem necessidade
          de cartão.
        </li>
        <li>
        ...
        <li>
          ...
          período já pago. Não há reembolso proporcional, salvo previsão legal.
        </li>
      </ul>
      ...
      <p>
        ...
        Lembretes por WhatsApp dependem de número válido informado pelo cliente.
        A Plataforma não garante comparecimento nem se responsabiliza por
        cancelamentos feitos pelo estabelecimento.
      </p>

      <h2>5. Conteúdo do estabelecimento</h2>
      <p>
        Fotos, marcas, textos e preços publicados na página do estabelecimento
        são de responsabilidade dele, que declara ter os direitos de uso.
        Podemos remover conteúdo que viole a lei ou estes termos.
      </p>

      <h2>6. Disponibilidade e suporte</h2>
      <p>
        Empregamos esforços razoáveis para manter o serviço disponível, mas ele
        pode sofrer interrupções por manutenção, falhas de terceiros ou força
        maior. Recursos podem ser adicionados, alterados ou descontinuados;
        mudanças que reduzam funções essenciais serão comunicadas com
        antecedência.
      </p>
      ...
      <p>
        ...
        ou anonimizados conforme a Política de Privacidade e os prazos legais de
        retenção.
      </p>
