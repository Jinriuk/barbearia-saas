...
/**
 * §5.3 e §10: no celular o painel lateral ocupa a tela inteira (antes era
 * `w-3/4`, que deixava uma faixa morta de 25% e apertava os formulários).
 * A partir de `sm` ele volta a ser um painel de largura fixa.
 */
