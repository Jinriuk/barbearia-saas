 ...
 * alcançável sem inflar a hierarquia.
 *
 * O Financeiro saiu desta lista na Fase 3.1: as suas cinco rotas viraram as
 * seis SEÇÕES INTERNAS do §7.5, navegadas por FinanceNav dentro da própria
 * página. As rotas antigas continuam existindo e redirecionam.
 */
export type SectionKey = "catalogo" | "equipe";
